...
- **Convergence is a trade, not an upgrade**, and the blurb says so. Focusing the mounts concentrates damage onto fewer craft: ~20% more score, more leaks. The flat `FOCUS_RANGE` is load-bearing — five mounts aiming at one distant point fan across a dense column. Don't "fix" it without re-reading DECISIONS 2026-08-08.
