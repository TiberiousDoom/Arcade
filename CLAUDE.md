...
- **[index.html](index.html)** — the cabinet: the game picker, self-contained apart from `scores.js` (personal bests on the cards), `unlocks.js` (which cards are dimmed) and `version.js`. It is the fifth page the service worker precaches and the navigation fallback for a failed request.
